...
export const Receipt = React.forwardRef(({ data }, ref) => {
  ...
  return (
    <div style={{ display: 'none' }}> {/* ซ่อนไว้ไม่ให้รกหน้าจอ (จะโชว์ตอนสั่งพิมพ์เท่านั้น) */}
      <div ref={ref} style={{ padding: '40px', fontFamily: 'Prompt', color: '#000', width: '100%', maxWidth: '800px' }}>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '20px' }}>
          ...
          <tbody>
            ...
            <tr style={{ borderBottom: '1px solid #ccc' }}>
              <td style={{ padding: '15px 10px' }}>ค่าบริการส่วนกลาง (Service Fee)</td>
              <td style={{ padding: '15px 10px', textAlign: 'right' }}>0 บาท</td>
            </tr>
          </tbody>
          <tfoot>
            <tr>
